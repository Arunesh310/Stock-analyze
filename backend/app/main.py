...
async def lifespan(app: FastAPI):
    ...
    if not serverless:
        ...
        # Lightweight scheduler only — see scheduler.py docstring. The heavy
        # compute (signal scan, dashboard refresh, overnight, pre-market, ML
        # retrain) runs on GitHub Actions and persists to Neon.
        start_scheduler()
    else:
